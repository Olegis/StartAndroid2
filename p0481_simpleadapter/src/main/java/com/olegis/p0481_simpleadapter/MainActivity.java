package com.olegis.p0481_simpleadapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    final static String ATTRIBUTE_NAME_TEXT = "text";
    final static String ATTRIBUTE_NAME_CHECKED = "checked";
    final static String ATTRIBUTE_NAME_IMAGE = "image";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // массивы данных
        String[] text = {"sometext 1", "sometext 2", "sometext 3", "sometext 4", "sometext 5"};
        ...
        //определяем список и присваиваем ему адапрер
