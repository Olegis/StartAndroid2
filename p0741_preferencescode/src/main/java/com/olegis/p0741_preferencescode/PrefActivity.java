package com.olegis.p0741_preferencescode;
...
public class PrefActivity extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chb4.setSummary("Description of checkbox4");
        ...
        chb5.setKey("chb5");
        chb5.setTitle("CheckBox5");
        chb5.setSummary("Description of checkbox5");
